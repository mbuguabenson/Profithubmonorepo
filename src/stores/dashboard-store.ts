...
export interface IDashboardStore {
    ...
    setToolhubSelectedTool: (toolhub_selected_tool: string) => void;
}
...
export default class DashboardStore implements IDashboardStore {
    ...
    faq_title = '';
    toolhub_selected_tool = 'expertstrade';

    setToolhubSelectedTool = (toolhub_selected_tool: string) => {
        this.toolhub_selected_tool = toolhub_selected_tool;
    };
